...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public JwtFilter(HandlerExceptionResolver handlerExceptionResolver, JwtUtility jwtUtility, CustomerUserDetailService userDetailService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try{
            ...
            handlerExceptionResolver.resolveException(request, response, null, new CustomException(Errors.ACCESS_DENIED, e));
        } catch (Exception e) {
